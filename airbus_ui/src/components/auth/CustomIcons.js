...
export function SitemarkIcon(props) {
  return (
    <SvgIcon {...props} sx={{ width: 120, height: 30 }} viewBox="0 0 200 50">
      <svg
        ...
        height="100%"
      >
        {/* Left abstract shape or icon */}
        <path
          d="M10 35L25 25L10 15V35Z"
          fill="#00D3AB"
        />
        <circle cx="25" cy="25" r="5" fill="#4876EF" />
        <circle cx="25" cy="25" r="2" fill="white" />

        {/* Text AIRVISION in a modern font-like path */}
        <text
          x="40"
          y="30"
          fill="#B4C0D3"
