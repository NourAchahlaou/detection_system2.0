// components/camera/LiveDetectionView.jsx - Enhanced with optimized backend integration
  ...
  return (
    <>
      ...
      >
        ...
        {/* Detection Counter */}
        <Badge badgeContent={detectionCount} color="primary" max={999}>
          <Chip
            icon={<Visibility />}
        ...
        <Chip
          icon={<Speed />}
          label={`${avgProcessingTime.toFixed(0)}ms`}
          size="small"
      ...
      >
        ...
        >
          ...
          <Typography variant="caption">
            {streamQuality}% • {detectionFps.toFixed(1)}fps
          </Typography>
        </Box>
      ...
      {showAdvancedStats && (
        ...
        >
          ...
          <Stack spacing={1}>
            ...
            <Box>
              <Typography variant="caption">
                Processing Time: {avgProcessingTime.toFixed(1)}ms
              </Typography>
              <LinearProgress
                variant="determinate"
                value={Math.min((avgProcessingTime / 200) * 100, 100)}
            ...
            <Box>
              <Typography variant="caption">
                Queue Depth: {queueDepth}/10
              </Typography>
              <LinearProgress
                variant="determinate"
                value={(queueDepth / 10) * 100}
            ...
            <Box>
              <Typography variant="caption">
                Detection Rate: {detectionFps.toFixed(1)}/5.0 fps
              </Typography>
              <LinearProgress
                variant="determinate"
                value={(detectionFps / 5) * 100}
