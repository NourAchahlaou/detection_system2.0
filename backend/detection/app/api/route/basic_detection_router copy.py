# basic_detection_router.py - Database-integrated detection router with lot management
...
async def create_detection_lot(lot_request: CreateLotRequest):
    """
    ...
    try:
        ...
        # Create the lot
        lot_response = await basic_detection_processor.create_detection_lot(creation_request)
...
async def get_detection_lot(lot_id: int):
    """
    ...
    try:
        ...
        lot_info = await basic_detection_processor.get_detection_lot(lot_id)
...
async def update_lot_target_match_status(lot_id: int, status_request: UpdateLotStatusRequest):
    """
    ...
    try:
        ...
        # Update lot status
        success = await basic_detection_processor.update_lot_target_match(
            lot_id, 
        ...
        updated_lot_info = await basic_detection_processor.get_detection_lot(lot_id)
...
async def detect_with_database_tracking(
    ...
    try:
        ...
        response = await basic_detection_processor.detect_with_lot_tracking(detection_request)
...
async def get_lot_detection_sessions(lot_id: int):
    """
    ...
    try:
        ...
        # Get sessions
        sessions = await basic_detection_processor.get_lot_sessions(lot_id)
        ...
        return JSONResponse(
            ...
            content={
                ...
                "lot_status": {
                    ...
                    "completed_at": lot_info.completed_at.isoformat() if lot_info.completed_at else None
                }
            }
        )
...
async def detect_with_automatic_lot_creation(
    ...
    try:
        ...
        lot_response = await basic_detection_processor.create_detection_lot(lot_creation)
        ...
        detection_response = await basic_detection_processor.detect_with_lot_tracking(detection_request)
...
async def detect_with_automatic_lot_correction(
    ...
    try:
        ...
        if detection_response.detected_target and auto_complete:
            ...
            await basic_detection_processor.update_lot_target_match(lot_id, True)
...
async def delete_detection_lot(lot_id: int):
    """
