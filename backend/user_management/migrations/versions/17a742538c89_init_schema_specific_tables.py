...
Revision ID: 17a742538c89
Revises: 
Create Date: 2025-05-18 15:42:43.158781
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('TECHNICIAN', 'ADMIN', 'AUDITOR', name='roletype', schema='user_mgmt'), nullable=False),
