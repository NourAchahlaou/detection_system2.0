...
# Create a router for auth-related endpoints that require authentication
...
async def update_profile(
    ...
    except profile.ProfileCompletionError as e:
        raise HTTPException(
...
async def get_user_profile(
    ...
    """
    Get the user's complete profile information including personal details, shifts, and profile completion status
    """
    try:
